...
exports.createListing = async (req, res) => {
    try {
        ...
        const listing = await Listing.create({
            ...
            unit,
            pricePerUnit: pricePerUnit !== undefined && pricePerUnit !== '' ? Number(pricePerUnit) : 0,
            initialPrice: initialPrice !== undefined && initialPrice !== '' ? Number(initialPrice) : 0,
            currentPrice: initialPrice !== undefined && initialPrice !== '' ? Number(initialPrice) : 0,
            expiryWindow,
            location,
